...
- **Android APK** - [Download NoteIt v1.0.0](releases/NoteIt-v1.0.0.apk) *(48MB)*
  ...
  - **Alternative**: [Download from Google Drive](https://drive.google.com/drive/folders/1cHN-z27kMmypxCaYrfNdPt0ulVurAj6G?usp=sharing) *(Recommended for Safari users)*
...
- **App Overview** - [Watch Demo](demos/ScreenRecording_07-24-2025%2010-00-02_1.mov) *(61MB)*
  ...
  - **Alternative**: [Watch on Google Drive](https://drive.google.com/drive/folders/1cHN-z27kMmypxCaYrfNdPt0ulVurAj6G?usp=sharing) *(Better for Safari/iOS users)*

### 📱 Safari Download Instructions
**If downloads don't work in Safari:**
1. **Use Google Drive link** - [Direct download](https://drive.google.com/drive/folders/1cHN-z27kMmypxCaYrfNdPt0ulVurAj6G?usp=sharing) *(Most reliable for Safari)*
